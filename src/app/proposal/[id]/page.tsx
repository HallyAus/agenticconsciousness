  ...
  return (
    <main className="min-h-screen" style={{ background: 'var(--bg-page)' }}>
      ...
      <article className="max-w-[800px] mx-auto py-16 px-10 max-md:px-5">
        ...
        {/* Summary */}
        <div className="mb-10">
          <div className="font-mono text-[0.7rem] tracking-[3px] uppercase mb-3" style={{ color: 'var(--red-text)' }}>OVERVIEW</div>
        ...
        {/* Scope */}
        <div className="mb-10">
          <div className="font-mono text-[0.7rem] tracking-[3px] uppercase mb-3" style={{ color: 'var(--red-text)' }}>SCOPE OF WORK</div>
        ...
        {/* Deliverables */}
        <div className="mb-10">
          <div className="font-mono text-[0.7rem] tracking-[3px] uppercase mb-3" style={{ color: 'var(--red-text)' }}>DELIVERABLES</div>
          <div className="flex flex-col gap-[2px]">
            {proposal.deliverables.map((d, i) => (
              <div key={i} className="flex gap-4 p-4" style={{ background: 'var(--bg-card)' }}>
                <span className="font-mono text-[0.7rem] font-bold" style={{ color: 'var(--red-text)' }}>
        ...
        {/* Timeline */}
        <div className="mb-10">
          <div className="font-mono text-[0.7rem] tracking-[3px] uppercase mb-3" style={{ color: 'var(--red-text)' }}>TIMELINE</div>
          <p className="text-text-dim text-[0.9rem] font-light">{proposal.timeline}</p>
        </div>

        {/* Pricing */}
        <div className="mb-10">
          <div className="font-mono text-[0.7rem] tracking-[3px] uppercase mb-3" style={{ color: 'var(--red-text)' }}>INVESTMENT</div>
          ...
          <p className="text-text-ghost text-[0.7rem] font-mono mt-2">All prices in AUD inclusive of GST.</p>
        </div>

        {/* Terms */}
        <div className="mb-10">
          <div className="font-mono text-[0.7rem] tracking-[3px] uppercase mb-3" style={{ color: 'var(--red-text)' }}>TERMS</div>
