...
// Curated Unsplash photo URLs. STRICT POLICY: equipment, work-in-progress,
// and scene-only photos. NO people-centric shots. Faces of any kind are
// a curation minefield (skin tone, age, gender all become unintentional
// targeting signals for the prospect's audience). Equipment/work shots
// avoid this entirely AND look more like a real tradie's portfolio than
// an HR catalogue. All photos free for commercial use under the
// Unsplash License (no attribution required). Sized w=1440 q=70.
const TRADE_PHOTOSETS: Record<string, string[]> = {
  electrician: [
    // Open switchboard, breaker panel, conduit, tools, copper wire close-ups
    'https://images.unsplash.com/photo-1558449907-8b82b0264682?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1620283085439-39620a1e21c4?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1573164574572-cb89e39749b4?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1635348729080-d2ddee5ec1f6?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=1440&q=70&fit=crop',
  ],
  plumber: [
    // Copper pipe, fittings, wrench on tap, leaking joint, hot water unit
    ...
    'https://images.unsplash.com/photo-1567361808960-dec9cb578182?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1606613762468-edf91e3aaadd?w=1440&q=70&fit=crop',
  ],
  roofer: [
    // Pitched roof tiles, gutters, ridge cap, flashing — no people
    ...
    'https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=1440&q=70&fit=crop',
  ],
  painter: [
    // Paint roller on wall, brush + tin, masked windows, swatches
    ...
    'https://images.unsplash.com/photo-1604147495798-57beb5d6af73?w=1440&q=70&fit=crop',
  ],
  carpenter: [
    // Timber + tools, mitre saw, joinery, framing, sawdust on planks
    ...
    'https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=1440&q=70&fit=crop',
  ],
  landscaper: [
    // Lawn, hedge, garden bed, mulch, paving — no people
  ...
  cleaner: [
    // Spray bottle, mop on tile, vacuum, sparkling sink — no people
  ...
  mechanic: [
    // Engine bay, tools, lift, brake disc, exhaust — no people
    ...
    'https://images.unsplash.com/photo-1599256871679-115ee1b8e8db?w=1440&q=70&fit=crop',
  ],
  hvac: [
    // AC condenser, ducting, thermostat, vents
  ...
  tiler: [
    // Tiled bathroom, kitchen splashback, grout, trowel
  ...
  concreter: [
    // Wet concrete, formwork, trowelled slab, exposed aggregate
    'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1440&q=70&fit=crop',
    'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=1440&q=70&fit=crop',
  ],
  fencer: [
    // Timber fence, colorbond panels, gate, post in ground
  ...
  pool: [
    // Clean pool water, tiled pool edge, equipment shed, pump
  ...
  cafe: [
    // Coffee machine, latte art, beans, croissants, interior
  ...
  restaurant: [
    // Plated dish, table setting, dimly lit interior, bar
  ...
  hairdresser: [
    // Salon chair, scissors + comb, products on shelf, mirror — no people
  ...
  florist: [
    // Bouquets, store interior, single flower, arrangement
  ...
  gym: [
    // Equipment, dumbbells, treadmills, empty studio — no people
  ...
  dentist: [
    // Chair + tools, instrument tray, modern surgery, sterilised tools
  ...
  physio: [
    // Treatment table, foam roller, resistance bands, anatomy chart — no faces
    ...
    'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=1440&q=70&fit=crop',
  ],
  lawyer: [
    // Books on shelf, pen on contract, courtroom interior, scales of justice
  ...
  accountant: [
    // Calculator on spreadsheet, charts, ledger, pen on report
  ...
  realestate: [
    // Modern home exterior, kitchen, "for sale" sign, open plan living
  ...
  pet: [
    // Dog at vet, animal close-up, surgery tools, treatment table
  ...
  photographer: [
    // Camera body, lens, tripod, lit studio, prints
