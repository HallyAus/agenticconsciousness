        ...
        <div className="grid grid-cols-2 gap-10 max-md:grid-cols-1 max-sm:gap-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="audit-industry" className="font-mono text-[0.8rem] max-sm:text-xs tracking-[2px] uppercase text-text-dim">
                Industry
              </label>
            ...
            {/* Business size */}
            <div className="flex flex-col gap-2">
              <label htmlFor="audit-business-size" className="font-mono text-[0.8rem] max-sm:text-xs tracking-[2px] uppercase text-text-dim">
                Business Size
              </label>
              <div className="relative">
                <select
          ...
          <div className="flex flex-col gap-6">
            ...
            {result && (
              <div className="flex flex-col gap-6">
                {/* Headline */}
                <div>
                  <div className="font-mono text-[0.8rem] max-sm:text-xs tracking-[3px] uppercase text-ac-red mb-2">
                    ...
                    >
                      <div className="flex items-start justify-between gap-4 mb-3">
                        ...
                        <div className="flex gap-2 flex-shrink-0 flex-wrap justify-end">
                          <span
                            className={`font-mono text-[0.8rem] max-sm:text-xs tracking-[1px] uppercase border px-2 py-1 ${
                              opp.impact === 'High'
                          ...
                          <span className="font-mono text-[0.8rem] max-sm:text-xs tracking-[1px] uppercase border border-border-subtle text-text-dim px-2 py-1">
                            {opp.timeframe}
                          </span>
                        </div>
                      </div>
