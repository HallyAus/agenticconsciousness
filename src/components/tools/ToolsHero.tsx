        ...
        <div className="flex gap-3 mb-14 flex-wrap">
          {tools.map((tool, i) => (
            <a
              key={tool.href}
              href={tool.href}
              className="font-display text-[0.8rem] max-sm:text-xs font-black tracking-[2px] uppercase py-3 px-5 no-underline transition-all duration-200 hover:-translate-y-[2px]"
              style={{
