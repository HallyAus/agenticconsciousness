      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex gap-16 max-sm:gap-8 max-sm:flex-wrap border-t pt-8" style={{ borderColor: 'var(--border-subtle)' }}>
          <div>
            ...
            <div className="font-mono text-[0.6rem] text-text-dim tracking-[2px] uppercase mt-1">Invoices scanned</div>
          </div>
          <div>
            <AnimatedCounter value={stats.quotes.toLocaleString()} className="text-[2rem] font-black tracking-tight" style={{ color: 'var(--red-text)' }} />
            <div className="font-mono text-[0.6rem] text-text-dim tracking-[2px] uppercase mt-1">Quotes generated</div>
          </div>
          <div>
            ...
            <div className="font-mono text-[0.6rem] text-text-dim tracking-[2px] uppercase mt-1">Competitors analysed</div>
          </div>
        </div>
      </div>
    </section>
